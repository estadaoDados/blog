...
<!--BEGIN #primary .hfeed-->
  ...
  <!--BEGIN .hentry-->
    <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
      <?php
        $options = get_option('pureline');
        if (($pureline_header_meta == "") || ($pureline_header_meta == "single_archive")) { ?>
          <h1 class="entry-title">
            <a href="<?php echo get_permalink($post->post_parent); ?>" rev="attachment" class="attach-font">
              <?php echo get_the_title($post->post_parent); ?>
            </a> &raquo; <?php
            if ( get_the_title() ){
              the_title();
            } else {
              _e( 'Untitled', 'pure-line' );
            } ?>
            ...
            <div class="entry-meta entry-header">
              <a href="<?php the_permalink() ?>">
                <span class="published">
                  <?php the_time('M d'); ?>, <?php the_time('Y'); ?>
                  </strong>
                </span>
              </a>
              ...
              <?php if ( comments_open() ) : ?>
                <span class="comment-count">
                   ~ <?php comments_popup_link( __( 'Leave a Comment', 'pure-line' ), __( '1 Comment', 'pure-line' ), __( '% Comments', 'pure-line' ) ); ?>
                </span>
              <?php endif; ?>
              <span class="author vcard">
                <?php _e( 'By', 'pure-line' ); ?> 
                <strong>
                  <?php printf( '<a class="url fn" href="' . get_author_posts_url( $authordata->ID, $authordata->user_nicename ) . '" title="' . sprintf( 'View all posts by %s', $authordata->display_name ) . '">' . get_the_author() . '</a>' ) ?>
                </strong>
              </span>
            </div>
          <!--END .entry-meta .entry-header-->
        <?php } else { ?>
          <h1 class="entry-title" class="fl-l">
            ...
            <?php
              if ( current_user_can( 'edit_post', $post->ID ) ):
                edit_post_link( __( 'EDIT', 'pure-line' ), '<span class="edit-post edit-attach">', '</span>' );
              endif;
            ?>
          </h1>
          <br /><br />
...
<div class="entry-caption"><?php if ( !empty( $post->post_excerpt ) ) the_excerpt(); ?></div>
 ...
 <?php if ( have_posts() ) : ?>
        ...
        <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
          ...
          <h1 class="entry-title"><?php if ( get_the_title() ){ the_title(); }else{ _e( 'Untitled', 'pure-line' );  } ?><?php edit_post_link( __( 'edit', 'pure-line' ), '<span class="edit-post">', '</span>' ); ?></h1>

                    <?php } else { ?>

                    <h1 class="entry-title fl-l"><?php the_title(); ?>
      ...
      <!--BEGIN .entry-content .article-->
          ...
          <?php if (($pureline_header_meta == "") || ($pureline_header_meta == "single") || ($pureline_header_meta == "single_archive")) { ?>
          <!--BEGIN .entry-meta .entry-header-->
          <div class="entry-meta entry-header">
 ...
 ----------------------->
  ...
  <?php } else { ?>
      ...
      <?php if ( have_posts() ) : ?>
        ...
        <h1 class="entry-title"><a href="<?php the_permalink(); ?>" rel="bookmark" title="Permanent Link to <?php the_title_attribute(); ?>"><?php if ( get_the_title() ){ the_title();}else{ _e( 'Untitled', 'pure-line' );  } ?></a><?php edit_post_link( __( 'edit', 'pure-line' ), '<span class="edit-post">', '</span>' ); ?>
</h1>
                    ...
                    <h1 class="entry-title fl-l"><a href="<?php the_permalink(); ?>" rel="bookmark" title="Permanent Link to <?php the_title_attribute(); ?>"><?php if ( get_the_title() ){ the_title();}else{ _e( 'Untitled', 'pure-line' );  } ?></a>
